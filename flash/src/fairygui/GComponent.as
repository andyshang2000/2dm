package fairygui
{
	...
	public class GComponent extends GObject
	{
		...
		protected function setupScroll(scrollBarMargin:Margin, scroll:int, scrollBarDisplay:int, flags:int, vtScrollBarRes:String, hzScrollBarRes:String):void
		{
			...
			_scrollPane = new ScrollPane(this, scroll, scrollBarMargin, scrollBarDisplay, flags, vtScrollBarRes, hzScrollBarRes);
		}
		...
		{
			var lang:Controller = getController("lang");
			if (lang != null)
			{
				lang.selectedPage = Game.lang;
			}
		}
